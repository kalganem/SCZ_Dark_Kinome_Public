...
The Integrated Network and Dynamical Reasoning Assembler (INDRA) database is a bibliometric knowledge aggregator consisting of unique, de-duplicated statements of causal biological mechanisms drawn from natural language processing of PubMed abstracts, PubMedCentral full texts, and a host of other resources such as Pathway Commons and BioGRID. INDRA is used to generate reports for some of targets:
